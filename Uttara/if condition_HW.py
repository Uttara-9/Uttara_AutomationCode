...
#Write a program check given number is divisible by 7 then add 50 in number else substract 50 from number#

print("Add 50 else substract 50 program output")
num2 = int(input("please enter a number:"))
valu1 = 7
if num2 % valu1 == 0:
	print("Number is divisibleby 7 so add 50 in given number", num2+50)
else:
	print("Number is not divisible by 7 so substract 50 from number", num2-50)